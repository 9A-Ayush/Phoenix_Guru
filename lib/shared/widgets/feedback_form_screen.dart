          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isLimitReached ? AppColors.errorLight : AppColors.primaryLight,
              ...
              Row(
                children: [
                  _buildTypeChip(type: FeedbackType.bug, label: 'Bug Report', icon: Symbols.bug_report),
                  const SizedBox(width: 8),
                  _buildTypeChip(type: FeedbackType.feature, label: 'Feature Request', icon: Symbols.lightbulb),
                  const SizedBox(width: 8),
                  _buildTypeChip(type: FeedbackType.general, label: 'General', icon: Symbols.chat),
                ],
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  counterStyle: GoogleFonts.poppins(color: AppColors.textMuted, fontSize: 11),
                ),
                validator: (value) {
              ...
              TextFormField(
                ...
                style: GoogleFonts.poppins(color: Colors.white, fontSize: 14),
                decoration: InputDecoration(
                  hintText: 'Provide detailed information about the issue or your suggestion...',
                  counterStyle: GoogleFonts.poppins(color: AppColors.textMuted, fontSize: 11),
                  alignLabelWithHint: true,
                ),
                validator: (value) {
                  if (value == null || value.trim().isEmpty) return 'Description is required';
                  if (value.trim().length < 20) return 'Please provide more details (min 20 characters)';
                  return null;
                },
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: isLimitReached || _isSubmitting ? null : _submitFeedback,
                  ...
                  child: _isSubmitting
                      ...
                      : Text(
                          ...
                          style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                            color: isLimitReached ? AppColors.textMuted : Colors.white,
                          ),
                        ),
                ),
