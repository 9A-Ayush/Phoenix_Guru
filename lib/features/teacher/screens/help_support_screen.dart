            ...
            child: ListView(
              ...
              children: [
                ...
                ...[
                  ...
                  (Symbols.bug_report, AppColors.warning, 'Report a Bug', 'Help us improve the app', 'We read every report'),
                ].asMap().entries.map((e) {
                  final i = e.key;
                  final item = e.value;
                  return Padding(
                    ...
                    ).animate().fadeIn(delay: (420 + i * 60).ms).slideX(begin: 0.05, end: 0),
                  );
                }),
