...
class _ResultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        // Navigate to test detail screen for tests, or show result screen for quizzes
        if (test.classId == 'live_quiz') {
          // For live quizzes, show the result screen
          Navigator.push(
            context,
            MaterialPageRoute(
          ...
          // For regular tests, show the test detail screen
          Navigator.push(
            context,
            MaterialPageRoute(
